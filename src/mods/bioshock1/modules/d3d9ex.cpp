...
#pragma region D3D9Device
	...
	HRESULT d3d9ex::D3D9Device::DrawPrimitiveUP(D3DPRIMITIVETYPE PrimitiveType, UINT PrimitiveCount, CONST void* pVertexStreamZeroData, UINT VertexStreamZeroStride)
	{
		...
		//shared::common::remix::set_texture_category(m_pIDirect3DDevice9, REMIXAPI_INSTANCE_CATEGORY_BIT_WORLD_MATTE);

		//return D3D_OK; // HUD
		auto hr = m_pIDirect3DDevice9->DrawPrimitiveUP(PrimitiveType, PrimitiveCount, pVertexStreamZeroData, VertexStreamZeroStride);

		//shared::common::remix::reset_texture_category(m_pIDirect3DDevice9);
...
#pragma endregion
	...
	d3d9ex::d3d9ex()
	{
		...
		shared::utils::hook::set(0x10FCA93C, d3d9ex::direct3d_create9_stub);
	}
}
