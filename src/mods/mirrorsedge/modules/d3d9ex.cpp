...
#pragma region D3D9Device
	...
	HRESULT d3d9ex::D3D9Device::DrawIndexedPrimitive(D3DPRIMITIVETYPE PrimitiveType, INT BaseVertexIndex, UINT MinVertexIndex, UINT NumVertices, UINT startIndex, UINT primCount)
	{
		...
		//shared::common::console(); std::cout << "Render Prim\n";




		auto hr = m_pIDirect3DDevice9->DrawIndexedPrimitive(PrimitiveType, BaseVertexIndex, MinVertexIndex, NumVertices, startIndex, primCount);
...
#pragma endregion
	...
	d3d9ex::d3d9ex()
	{
		...
		shared::utils::hook::set(0x1A8BC3C, d3d9ex::direct3d_create9_stub);
	}
}
