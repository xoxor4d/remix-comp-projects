	...
	void cont_general_quickcommands()
	{
...

		{
			...
			cont_cull_height = ImGui::Widget_ContainerWithCollapsingTitle("Culling Tweaks", cont_cull_height, [&]
			{
				...
				SET_CHILD_WIDGET_WIDTH_MAN(140.0f); ImGui::SliderFloat3("Camera Position (X, Y, Z)", im->m_dbg_camera_pos, -10000.0f, 10000.0f);
				...
				SET_CHILD_WIDGET_WIDTH_MAN(140.0f); ImGui::SliderFloat("FOV", &im->m_dbg_camera_fov, 1.0f, 180.0f);
				SET_CHILD_WIDGET_WIDTH_MAN(140.0f); ImGui::SliderFloat("Aspect Ratio", &im->m_dbg_camera_aspect, 0.2f, 3.555f);
				SET_CHILD_WIDGET_WIDTH_MAN(140.0f); ImGui::SliderFloat("Near Plane", &im->m_dbg_camera_near_plane, 0.1f, 1000.0f);
				SET_CHILD_WIDGET_WIDTH_MAN(140.0f); ImGui::SliderFloat("Far Plane", &im->m_dbg_camera_far_plane, 100.0f, 100000.0f);
